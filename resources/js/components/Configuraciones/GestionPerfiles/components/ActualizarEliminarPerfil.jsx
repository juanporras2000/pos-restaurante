...
export const ActualizarEliminarPerfil = ({
    ...
    return (
        <div className="bg-white dark:bg-gray-800 p-4 sm:p-5 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm w-full min-w-0">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input
                        ...
                        enterKeyHint="next"
                        className="w-full h-11 px-3.5 bg-gray-50 dark:bg-gray-900 rounded-xl text-sm border border-transparent focus:border-transparent focus:ring-2 focus:ring-green-500 outline-none font-semibold text-gray-800 dark:text-gray-100"
                    />
                </div>
                <div>
                    <label className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-wider block mb-1">
                    ...
                    <input
                        ...
                        className="w-full h-11 px-3.5 bg-gray-50 dark:bg-gray-900 rounded-xl text-sm border border-transparent focus:border-transparent focus:ring-2 focus:ring-green-500 outline-none font-semibold text-gray-800 dark:text-gray-100 tracking-widest"
                    />
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
                ...
                <div className="flex flex-col justify-end">
                    <button
                        ...
                        className="w-full h-11 bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-xl text-sm font-bold hover:bg-blue-100 dark:hover:bg-blue-900/50 transition-all flex items-center justify-center gap-2 touch-manipulation shadow-sm"
                    >
            ...
            <div className="mt-5 flex items-center gap-3">
                ...
                <button
                    ...
                    className="h-12 px-4 bg-red-50 dark:bg-red-900/30 text-red-500 dark:text-red-400 hover:bg-red-500 hover:text-white active:bg-red-600 rounded-xl transition-all flex items-center justify-center flex-shrink-0 touch-manipulation border border-red-100 dark:border-red-800 hover:border-transparent shadow-sm"
                >
