...
export const PedidoMesa = ({ pedidosPendientes, cargarPendientes, productos, setEliminado, eliminado, setPagado, pagado, setActualizado, actualizado }) => {
    ...
    return (
        <div className="mb-6 md:mb-10 px-2 sm:px-4 md:px-0">
            <h2 className="text-lg md:text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4 flex flex-wrap items-center gap-2">
                ...
                <span className="bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400 text-xs font-medium px-2.5 py-0.5 rounded-full shrink-0">
